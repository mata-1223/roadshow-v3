...
function ActionExample({ actionsData, intent, bundleProfile, scenarioId }) {
      ...
      {open && (
        <>
          ...
          <div className="ax-modal" role="dialog">
            ...
            <ActionPanel actionsData={actionsData} topN={[intent]} reasoning={intent.reasoning} bundleProfile={bundleProfile} scenarioId={scenarioId} />
          </div>
        </>
      )}
    </div>
...
export default function IntentChart({ topN, actionsData, l1Zones, bundleProfile = null, scenarioId = null }) {
        ...
        <div key={t.intent_id} className="row">
          <div className="meta">
            ...
            {actionsMap[t.intent_id] && (
              <ActionExample actionsData={actionsData} intent={t} bundleProfile={bundleProfile} scenarioId={scenarioId} />
            )}
